...
public class MainActivity extends AppCompatActivity {
    ...
    private static String RAW_JSON_RESULT = "rawjsonresult";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(RAW_JSON_RESULT)){
                String txt = savedInstanceState.getString(RAW_JSON_RESULT);
                mSearchResultsTextView.setText(txt);
            }
            if(savedInstanceState.containsKey(URL_KEY)){
                String txt = savedInstanceState.getString(URL_KEY);
                mUrlDisplayTextView.setText(txt);
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(URL_KEY, UrlContent);

        String rawJsonText = mSearchResultsTextView.getText().toString();
        outState.putString(RAW_JSON_RESULT,rawJsonText);
    }
