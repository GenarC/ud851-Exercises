...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try{
            pSize = Integer.parseInt(mNewPartySizeEditText.getText().toString());
        }catch (Exception ex){
            Log.d("Parse Error", "Party size couldn't converted to an integer");
        }
        ...
        addGuest(mNewGuestNameEditText.getText().toString(), pSize);
