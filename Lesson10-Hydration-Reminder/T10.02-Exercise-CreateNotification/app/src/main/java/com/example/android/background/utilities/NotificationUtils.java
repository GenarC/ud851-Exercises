...
public class NotificationUtils {
    ...
    private static final int PENDING_INTENT_ID = 9853;
    private static final String REMINDER_NOTF_ID = "reminder_notf_id";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notfBuilder = new NotificationCompat.Builder(context,REMINDER_NOTF_ID)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN
            ...
            notfBuilder.setPriority(NotificationCompat.PRIORITY_HIGH);
        }
        // TODO (12) Trigger the notification by calling notify on the NotificationManager.
        // Pass in a unique ID of your choosing for the notification and notificationBuilder.build()
        nm.notify(PENDING_INTENT_ID,notfBuilder.build());
    }
