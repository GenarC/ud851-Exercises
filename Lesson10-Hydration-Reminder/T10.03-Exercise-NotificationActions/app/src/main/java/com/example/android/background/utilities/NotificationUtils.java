...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 87236;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 87235;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        NotificationCompat.Action notfAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"No Thanks", pendingIntent);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action notfAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,"Ups, I did it Again", pendingIntent);
