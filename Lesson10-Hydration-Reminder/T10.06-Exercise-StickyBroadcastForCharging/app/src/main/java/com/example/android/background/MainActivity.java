...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            int batteryStat = batteryStatus.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
                // TODO (8) Update the UI using your showCharging method
            boolean isCharging = (batteryStat == BatteryManager.BATTERY_STATUS_CHARGING) || (batteryStat == BatteryManager.BATTERY_STATUS_FULL);
