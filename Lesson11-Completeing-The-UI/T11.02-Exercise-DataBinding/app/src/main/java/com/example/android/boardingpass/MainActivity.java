...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        String deptTime = formatter.format(info.departureTime);
        String arvTime = formatter.format(info.arrivalTime);

        mBinding.textViewBoardingTime.setText(boardingTime);
        mBinding.textViewDepartureTime.setText(deptTime);
        mBinding.textViewArrivalTime.setText(arvTime);
